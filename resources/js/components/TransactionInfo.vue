            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="6" md="3">
                            <v-menu disabled v-model="menu2" :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="auto">
                        ...
                        <v-col cols="12" sm="6" md="3">
                            <v-menu disabled v-model="menu6" :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="auto">
                                <template v-slot:activator="{ on, attrs2 }">
                        ...
                        <v-col cols="12" sm="12" md="12">
                            <v-card>
                                <v-alert type="primary" outlined>
                                    ...
                                    <v-form disabled id="UpdateInstitutionForm" @submit.prevent="UpdateInstitution()">
                                        <v-row>
                        ...
                        <v-col cols="12" sm="12" md="12">
                            <v-card>
                                <v-alert type="primary" outlined>
                                    ...
                                    <v-col cols="12" sm="6" md="3">
                                        <v-text-field disabled @change="SetFinancialDates()" v-model="Transaction.financial_year" outlined :rules="numbersRules" :label="$t('finaincialYear')" required />
                                    </v-col>
                                    <v-col cols="12" sm="6" md="3">
                                        <v-autocomplete disabled @change="SetFinancialDates()" v-model="Transaction.financial_period" outlined :rules="required" :items="[$t('finaincialYear2'), $t('shortPeriod'), $t('longPeriod')]" item-text="value" item-value="value" :label="$t('finaincialPeriod')" required />
                                    </v-col>
                                    <v-col cols="12" sm="6" md="3">
                                        <v-menu disabled :close-on-content-click="false" :nudge-right="40" transition="scale-transition" offset-y min-width="auto">
                                            <template v-slot:activator="{ on, attrs2 }">
...
export default {
    ...
    data() {
        return {
            ...
            BranchedTradeRegisters: this.$parent.Transaction.institution.branched_trade_register,
            Institution: this.$parent.Transaction.institution,
            InstitutionTypes: [{
            ...
            revisers: [],
            revisingManagers: [],
            ChoosenReviser: this.$parent.Transaction.reviser,
            ChoosenRevisingManager: this.$parent.Transaction.revising_manager,

            legal_entityOptions: [],
            angel_interestsOptions: [],
            natureOptions: [],
            cityOptions: [],
            City: this.$parent.Transaction.institution.address ? this.$parent.Transaction.institution.address.split(',')[0] : '',
            RestOfAddress: this.$parent.Transaction.institution.address ? this.$parent.Transaction.institution.address.split(',')[1] : '',
